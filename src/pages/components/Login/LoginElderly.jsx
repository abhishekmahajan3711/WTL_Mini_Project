...
const LoginElderly = () => {
  ...
  const handleSignIn = async (e) => {
    ...
    try {
      ...
      const q = query(collection(db, 'ElderlyUsers'), where('email', '==', email),where('password','==',password));
  ...
  return (
    <div class="m-auto p-4 w-2/4 bg-blue-50 rounded-2xl">
      <h2 class="p-4 text-center text-2xl font-bold font-serif">Login as Elderly User</h2>
